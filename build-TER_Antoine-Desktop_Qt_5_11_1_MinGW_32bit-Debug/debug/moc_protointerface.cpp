...
QT_MOC_LITERAL(8, 122, 15), // "on_bTOR_pressed"
QT_MOC_LITERAL(9, 138, 16), // "on_bTOR_released"
QT_MOC_LITERAL(10, 155, 13) // "repaintCadres"

    },
    "ProtoInterface\0refreshCadres\0\0"
    "on_bDebut_clicked\0on_bFin_clicked\0"
    "on_bPause_clicked\0on_bReprise_clicked\0"
    "on_bUrgence_clicked\0on_bTOR_pressed\0"
    "on_bTOR_released\0repaintCadres"
};
...
void ProtoInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->on_bTOR_pressed(); break;
        case 7: _t->on_bTOR_released(); break;
        case 8: _t->repaintCadres(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ProtoInterface::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProtoInterface::refreshCadres)) {
                *result = 0;
                return;
            }
        }
